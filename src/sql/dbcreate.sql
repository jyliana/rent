...
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Mazda', '6', 1, 2500.00, false);
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Toyota', 'Camry VX70', 1, 3700.00, false);
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Porsche', 'Cayenne', 2, 9000.00, false);
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Mercedes-Benz', 'S500', 2, 9100.00, false);
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Ford', 'Fiesta VI', 0, 1000.00, false);
INSERT INTO `rental`.`cars` (`brand`, `model`, `class`, `price`, `is_booked`) VALUES ('Renault', 'Logan TDI', 0, 1300.00, false);